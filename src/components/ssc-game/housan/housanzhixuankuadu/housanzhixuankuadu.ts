...
/**
 * Generated class for the HousanzhixuankuaduComponent component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
@Component({
  selector: 'housanzhixuankuadu',
  templateUrl: 'housanzhixuankuadu.html'
})
export class HousanzhixuankuaduComponent extends commonMethod{

  text: string;

  constructor(public common:CommonProvider, public util:UtilProvider,public basket:BasketDataProvider) {
    super(common,util,basket) 
    console.log('Hello HousanzhixuankuaduComponent Component');
