...
/**
 * Generated class for the SixingermabudingweiComponent component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
@Component({
  selector: 'sixingermabudingwei',
  templateUrl: 'sixingermabudingwei.html'
})
export class SixingermabudingweiComponent extends commonMethod{
  ...
  constructor(public common:CommonProvider, public tool:ToolsProvider, public util:UtilProvider,public basket:BasketDataProvider){
    ...
    console.log('Hello SixingermabudingweiComponent Component');
