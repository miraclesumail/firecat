...
/**
 * Generated class for the WuxingermabudingweiComponent component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
@Component({
  selector: 'wuxingermabudingwei',
  templateUrl: 'wuxingermabudingwei.html'
})
export class WuxingermabudingweiComponent extends commonMethod{
  ...
  constructor(public common:CommonProvider, public tool:ToolsProvider, public util:UtilProvider,public basket:BasketDataProvider){
    ...
    console.log('Hello WuxingermabudingweiComponent Component');
