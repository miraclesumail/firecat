...
/**
 * Generated class for the ErxingzhixuanqianerkuaduComponent component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
@Component({
  selector: 'erxingzhixuanqianerkuadu',
  templateUrl: 'erxingzhixuanqianerkuadu.html'
})
export class ErxingzhixuanqianerkuaduComponent extends commonMethod{
