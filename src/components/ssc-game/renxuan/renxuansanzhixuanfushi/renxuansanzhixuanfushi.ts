...
/**
 * Generated class for the RenxuansanzhixuanfushiComponent component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
@Component({
  selector: 'renxuansanzhixuanfushi',
  templateUrl: 'renxuansanzhixuanfushi.html'
})
export class RenxuansanzhixuanfushiComponent extends commonMethod{
