...
/**
 * Generated class for the Renxuanzuxuan6Component component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
@Component({
  selector: 'renxuanzuxuan6',
  templateUrl: 'renxuanzuxuan6.html'
})
export class Renxuanzuxuan6Component extends commonMethod{
