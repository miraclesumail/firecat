...
/**
 * Generated class for the RenxuanqizhongwudantuoComponent component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
@Component({
  selector: 'renxuanqizhongwudantuo',
  templateUrl: 'renxuanqizhongwudantuo.html'
})
export class RenxuanqizhongwudantuoComponent extends commonMethod{
  arr: any = []
  text: string;
  ...
  constructor(public common:CommonProvider, public util:UtilProvider,public tool:ToolsProvider,public basket:BasketDataProvider) {
    ...
    console.log('Hello RenxuanqizhongwudantuoComponent Component');
